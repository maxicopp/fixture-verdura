...
export default function Champion({ champion, standings }: ChampionProps) {
        ...
        {standings.length >= 3 && (
          <div className="champion-podium">
            <div className="podium-item podium-2">
              <img src={`/players/${standings[1].name.toLowerCase()}.png`} alt={standings[1].name} className="podium-avatar" />
            ...
            <div className="podium-item podium-1">
              <img src={`/players/${standings[0].name.toLowerCase()}.png`} alt={standings[0].name} className="podium-avatar podium-avatar-winner" />
              <span className="podium-medal">🥇</span>
            ...
            <div className="podium-item podium-3">
              <img src={`/players/${standings[2].name.toLowerCase()}.png`} alt={standings[2].name} className="podium-avatar" />
              <span className="podium-medal">🥉</span>
