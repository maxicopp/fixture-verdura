...
import type { Standing, Quote } from '../types'

async function fetchMotivationalQuote(): Promise<Quote> {
...
export default function Standings({ standings, disabledPlayers = [] }: StandingsProps) {
