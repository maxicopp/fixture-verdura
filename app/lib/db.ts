...
export async function initSchema() {
  ...
  try { await db.execute("ALTER TABLE matches ADD COLUMN home_penalties INTEGER DEFAULT NULL") } catch { /* ya existe */ }
  try { await db.execute("ALTER TABLE matches ADD COLUMN away_penalties INTEGER DEFAULT NULL") } catch { /* ya existe */ }
}
